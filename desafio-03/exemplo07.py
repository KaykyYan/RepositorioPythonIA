...
# (some a pontuação do exame com a média anteriormente calculada 
# e divida por 2). e imprima a mensagem "Aluno aprovado." 
# (caso a média final seja 5.0 ou mais) 
# ou "Aluno reprovado.", (caso a média tenha ficado 4.9 ou menos). 
# Para estes dois casos
# (aprovado ou reprovado após ter pego exame) apresente 
# na última linha uma mensagem "Media
...
# Saída: Todas as respostas devem ser apresentadas 
# com uma casa decimal. As mensagens devem ser impressas 
