...
# sobre suas vendas efetuadas, informar o total
...
tt_de_vendas = float(input('Digite o total de vendas: '))
comissao = 0.15 * tt_de_vendas
salario_total = salario_fixo + comissao

print(f'Salario total do : {nome_do_vendedor} é: R$ {salario_total}')
